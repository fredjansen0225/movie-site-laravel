...
class Helpers
{
	...
	public static function getGoogleProxiesText()
	{
		return file_get_contents(app_path('google-proxies.txt'));
	}

	public static function getGeneralProxiesText()
	{
		return file_get_contents(app_path('general-proxies.txt'));
	}
}