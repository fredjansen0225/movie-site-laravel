...
@section('content')
	...
	<div class="container content">
		<div id="pagi-bar" class="row">
			...
			<button data-bind="click: app.paginator.currentPage(app.paginator.totalPages()), enable: app.paginator.hasNext" class="next col-xs-1 btn btn-primary"><span class="fa fa-forward"></span></button>		</div>
		...
		<section data-bind="foreach: sourceItems">
			<div class="media">
			  	...
			  	<div class="media-body">
			    	...
			    	<p data-bind="text: body.replace(/(<([^>]+)>)/ig,'').trunc(400)"></p>
