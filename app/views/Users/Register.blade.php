  ...
  <div class="container">
    ...
    <div class="col-sm-8" id="login-box">
      ...
      <div class="col-md-5 social-login-btns">
        <a class="btn btn-block fb" href="{{ url('social/facebook') }}"><i class="fa fa-facebook-square"></i> {{ trans('main.signup with fb') }}</a>
        <a class="btn btn-block tw" href="{{ url('social/twitter') }}"><i class="fa fa-twitter-square"></i> {{ trans('main.signup with tw') }}</a>
        <a class="btn btn-block go" href="{{ url('social/google') }}"><i class="fa fa-google-plus-square"></i> {{ trans('main.signup with gg') }}</a>
      </div>
