	...
	<div class="tab-content">
		<div class="tab-pane active" id="scraper-log">
			<div style="text-align: center;">
				...
				<div class="well2">
					<h2 class="queuep_count">0</h2>
					<p>Titles in Putlocker Scraper Queue</p>
				</div>
				<div class="well2">
					<h2 class="day_scrapep_count">0</h2>
					<p>Titles Scraped in Past 24 hrs</p>
				</div>
				<div class="well2">
				...
				<tfoot>
					<tr>
						<td class="load-more" colspan="7" style="text-align:center;">
							<a href="#" class="btn prev" onclick="loadMore(this);return false;" data-url="/link-scraper/titles" data-page="0">Prev</a> | <a href="#" class="btn next" onclick="loadMore(this);return false;" data-url="/link-scraper/titles" data-page="1">Next</a>
						</td>
					</tr>
				</tfoot>
			</table>
		...
		<div class="tab-pane" id="titles-without-links">
			...
			<table  style="width:100%;border-color:#CCCCCC;border-spacing: 1px;border-collapse: separate;" border="1">
				...
				<tfoot>
					<tr>
						<td class="load-more" colspan="7" style="text-align:center;">
							<a href="#" class="btn prev" onclick="loadMore(this);return false;" data-url="/link-scraper/titles-without-links" data-page="0">Prev</a> | <a href="#" class="btn next" onclick="loadMore(this);return false;" data-url="/link-scraper/titles-without-links" data-page="1">Next</a>
						</td>
					</tr>
				</tfoot>
			</table>
		...
		<div class="tab-pane" id="bad-links">
			...
			<table style="width:100%;border-color:#CCCCCC;border-spacing: 1px;border-collapse: separate;" border="1">
				...
				<tfoot>
					<tr>
						<td class="load-more" colspan="7" style="text-align:center;">
							<a href="#" class="btn prev" onclick="loadMore(this);return false;" data-url="/link-scraper/bad-links" data-page="0">Prev</a> | <a href="#" class="btn next" onclick="loadMore(this);return false;" data-url="/link-scraper/bad-links" data-page="1">Next</a>
						</td>
					</tr>
				</tfoot>
			</table>
...
<script type="text/javascript">
	...
	function updateScraper()
	{
		...
		$.post('/link-scraper/logp', { lastLogId: lastLogId }, function(json) {

			$('h2.queuep_count').html(json.queuep_count);
			$('h2.day_scrapep_count').html(json.day_scrapep_count);
			$('h2.total_scraped_count').html(json.total_scraped_count)
			$('span.page-count').html(json.page_count);
			$('tr.log:gt(25)').remove();
			insertLogs(json.logsp);
	...
	function rescrapeAll(button)
	{
		...
		$.post('/link-scraper/scrape', function(response) {
	...
	function rescrapeLinks(button)
	{
		...
		$.post('/link-scraper/scrape', { titleId: $(button).closest('tr').attr('data-title-id') }, function(response) {
			$(button).html(originalContent);
		});
