		...
		<div class="content clearfix">
			...
			<section class="dash-padding">
		 		<div class="scraper-container col-sm-4">
			 		...
			 		<hr/>
			 		<div class="scraper-contents">
			 			<h4><i class="fa fa-wrench"></i>Scrapers</h4>
			 			<?php echo link_to('dashboard/title-scraper', 'IMDB', $attributes = array('class'=>'btn btn-primary'), $secure = null); ?>
			 			<br/><br/>
			 			<?php echo link_to('dashboard/link-scraper', 'Primewire', $attributes = array('class'=>'btn btn-primary'), $secure = null); ?>
			 			<br/><br/>
			 			<?php echo link_to('dashboard/linkp-scraper', 'Putlocker ', $attributes = array('class'=>'btn btn-primary'), $secure = null); ?>
						
						 <br/><br/>
                        <?php echo link_to('dashboard/linkz-scraper', 'ZMovie', $attributes = array('class'=>'btn btn-primary'), $secure = null); ?>
			 		</div>
		 		</div>
