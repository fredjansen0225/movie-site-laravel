(function($) {
    ...
    app.viewModels.titles.create = {
        ...
        addSeason: function() {
            ...
            app.utils.ajax({
                url: vars.urls.baseUrl+'/series/'+vars.title.id+'/seasons',
        ...
        addEpisode: function() {
            ...
            app.utils.ajax({
                url: vars.urls.baseUrl+'/series/'+vars.title.id+'/seasons/'+self.activeSeason().id+'/episodes',
        ...
        removeEpisode: function(episode) {
            ...
            app.utils.ajax({
                ...
                type: 'DELETE',
                url: vars.urls.baseUrl+'/series/'+vars.title.id+'/seasons/'+self.activeSeason().id+'/episodes/'+episode.id,
                success: function(resp) {
                    app.utils.noty(resp, 'success');
        ...
        deleteSeason: function() {
            ...
            app.utils.ajax({
                data: ko.toJSON({ _token: vars.token }),
                type: 'DELETE',
                url: vars.urls.baseUrl+'/series/'+vars.title.id+'/seasons/'+self.activeSeason().id,
                success: function(resp) {
                    app.utils.noty(resp, 'success');
        ...
        addLink: function() {
            ...
            if (link.url().indexOf("iframe") > -1) {
                app.models.link.url(link.url().match(/src="([^"]+)"/)[1]);
            }

            app.models.link.title_id = app.models.title.id;
        ...
        removeLink: function(link) {
            ...
            if (vars.title) {
                app.utils.ajax({
                    ...
                    data: ko.toJSON({ _token: vars.token, title_id: app.models.title.id, url: link.url }),
                });
            }       
        },
